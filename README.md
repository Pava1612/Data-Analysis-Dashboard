...
6.  Analyze the relationship between age and gender based on the number
    of orders.
...
-   Ensured data consistency in terms of data types, formats, and
    values.
-   Created pivot tables for all analytical questions.
...
-   Top 3 states contributing to sales: **Maharashtra, Karnataka, Uttar
    Pradesh**.
-   Adult age group (30--49 years) contributed the most (\~50%).
